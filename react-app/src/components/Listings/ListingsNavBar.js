...
const ListingsNavBar = () => {
  return (
    <ul className='categories__navlinks'>
      <NavLink className='categories__titles' to={'/category/Prehistoric'}>Prehistoric<span>Before 3000 B.C.</span></NavLink>
      ...
      <NavLink className='categories__titles' to='/category/Future'>Future<span>After 2100 A.D.</span></NavLink>
    </ul>
  )
}
